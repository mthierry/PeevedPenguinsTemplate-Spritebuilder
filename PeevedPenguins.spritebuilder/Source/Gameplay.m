...
- (void)touchBegan:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint([_catapultArm boundingBox], touchLocation))
    {
        ...
        // create a penguin from the Penguin class
...
// This method is automatically called by Cocos2D every frame
- (void)update:(CCTime)delta
{
    // checks will only be performed after firing the penguin
